...
] satisfies { text: LintekCommitee; id: string; color: string; kår: 'LinTek' }[]
...
] satisfies { text: ConsensusCommitee; id: string; color: string; kår: 'Consensus' }[]
...
] satisfies { text: StuffCommitee; id: string; color: string; kår: 'StuFF' }[]
